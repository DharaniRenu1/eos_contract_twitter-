(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5hello2hiEy $_ZN5hello6hello1Ev)
 (memory $0 1)
 (data (i32.const 4) "\d0a\00\00")
 (data (i32.const 16) "onerror\00")
 (data (i32.const 32) "eosio\00")
 (data (i32.const 48) "onerror action\'s are only valid from the \"eosio\" system account\00")
 (data (i32.const 112) "Hello World\00")
 (data (i32.const 128) "read\00")
 (data (i32.const 144) "Hello, World\00")
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (block $label$13
   ...
   (drop
    (call $_ZN5eosio14execute_actionI5helloS1_JEEEbPT_MT0_FvDpT1_E
     (i32.add
      (get_local $9)
      (i32.const 40)
     )
 ...
 (func $_ZN5hello6hello1Ev (type $FUNCSIG$vi) (param $0 i32)
  (call $prints
   (i32.const 112)
  )
 )
 (func $_ZN5eosio14execute_actionI5helloS1_JEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
